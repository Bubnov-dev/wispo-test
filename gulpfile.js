...
function watchFiles() {
  ...
  gulp.watch([path.watch.lib], {usePolling: true}, lib);
}
...
const build = gulp.series(clean, gulp.parallel(js, css, html, lib, images, fonts), fontsStyle)
